...
"""
@data_router.post("/scraping/{link_url}")
async def scraping_endpoint(link_url: str):
    print(f"Scraping URL: {link_url}")
    data_controller = DataController()
    file_paths = data_controller.scraping(base_url=link_url,num_pages=2)
    return JSONResponse(
        content = {
